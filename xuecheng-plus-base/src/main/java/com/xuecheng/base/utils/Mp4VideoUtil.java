...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        // ProcessBuilder builder = new ProcessBuilder();
        // builder.command("F:\\DevelopmentTool\\ffmpeg\\ffmpeg.exe");
        //ffmpeg的路径
        String ffmpeg_path = "F:\\DevelopmentTool\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "F:\\1.avi";
        //转换后mp4文件的名称
        String mp4_name = "1111.mp4";
        //转换后mp4文件的路径
        String mp4_path = "F:\\1111.mp4";
        //创建工具类对象
